...
const Nav = () => {
  ...
  return <nav className='flex flex-col items-center gap-y-4  xl:justify-center fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-extw-md xl:h-screen'>
    {/* inner */}
